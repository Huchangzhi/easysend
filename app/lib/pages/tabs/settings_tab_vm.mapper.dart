...
class SettingsTabVmMapper extends ClassMapperBase<SettingsTabVm> {
  ...
  static TextEditingController _$easyTierNetworkNameController(
    SettingsTabVm v,
  ) => v.easyTierNetworkNameController;
  static const Field<SettingsTabVm, TextEditingController>
  _f$easyTierNetworkNameController = Field(
    'easyTierNetworkNameController',
    _$easyTierNetworkNameController,
  );
  static TextEditingController _$easyTierNetworkSecretController(
    SettingsTabVm v,
  ) => v.easyTierNetworkSecretController;
  static const Field<SettingsTabVm, TextEditingController>
  _f$easyTierNetworkSecretController = Field(
    'easyTierNetworkSecretController',
    _$easyTierNetworkSecretController,
  );
  static TextEditingController _$easyTierPublicServerUrlController(
    SettingsTabVm v,
  ) => v.easyTierPublicServerUrlController;
  static const Field<SettingsTabVm, TextEditingController>
  _f$easyTierPublicServerUrlController = Field(
    'easyTierPublicServerUrlController',
    _$easyTierPublicServerUrlController,
  );
  static Function _$onChangeEasyTierEnabled(SettingsTabVm v) =>
      (v as dynamic).onChangeEasyTierEnabled as Function;
  static dynamic _arg$onChangeEasyTierEnabled(f) => f<void Function(bool)>();
  static const Field<SettingsTabVm, Function> _f$onChangeEasyTierEnabled =
      Field(
        'onChangeEasyTierEnabled',
        _$onChangeEasyTierEnabled,
        arg: _arg$onChangeEasyTierEnabled,
      );
  static Function _$onChangeEasyTierNetworkName(SettingsTabVm v) =>
      (v as dynamic).onChangeEasyTierNetworkName as Function;
  static dynamic _arg$onChangeEasyTierNetworkName(f) =>
      f<void Function(String)>();
  static const Field<SettingsTabVm, Function> _f$onChangeEasyTierNetworkName =
      Field(
        'onChangeEasyTierNetworkName',
        _$onChangeEasyTierNetworkName,
        arg: _arg$onChangeEasyTierNetworkName,
      );
  static Function _$onChangeEasyTierNetworkSecret(SettingsTabVm v) =>
      (v as dynamic).onChangeEasyTierNetworkSecret as Function;
  static dynamic _arg$onChangeEasyTierNetworkSecret(f) =>
      f<void Function(String)>();
  static const Field<SettingsTabVm, Function> _f$onChangeEasyTierNetworkSecret =
      Field(
        'onChangeEasyTierNetworkSecret',
        _$onChangeEasyTierNetworkSecret,
        arg: _arg$onChangeEasyTierNetworkSecret,
      );
  static Function _$onChangeEasyTierPublicServerUrl(SettingsTabVm v) =>
      (v as dynamic).onChangeEasyTierPublicServerUrl as Function;
  static dynamic _arg$onChangeEasyTierPublicServerUrl(f) =>
      f<void Function(String)>();
  static const Field<SettingsTabVm, Function>
  _f$onChangeEasyTierPublicServerUrl = Field(
    'onChangeEasyTierPublicServerUrl',
    _$onChangeEasyTierPublicServerUrl,
    arg: _arg$onChangeEasyTierPublicServerUrl,
  );
  ...
  final MappableFields<SettingsTabVm> fields = const {
    ...
    #easyTierNetworkNameController: _f$easyTierNetworkNameController,
    #easyTierNetworkSecretController: _f$easyTierNetworkSecretController,
    #easyTierPublicServerUrlController: _f$easyTierPublicServerUrlController,
    #onChangeEasyTierEnabled: _f$onChangeEasyTierEnabled,
    #onChangeEasyTierNetworkName: _f$onChangeEasyTierNetworkName,
    #onChangeEasyTierNetworkSecret: _f$onChangeEasyTierNetworkSecret,
    #onChangeEasyTierPublicServerUrl: _f$onChangeEasyTierPublicServerUrl,
  ...
  static SettingsTabVm _instantiate(DecodingData data) {
    return SettingsTabVm(
      ...
      easyTierNetworkNameController: data.dec(_f$easyTierNetworkNameController),
      easyTierNetworkSecretController: data.dec(
        _f$easyTierNetworkSecretController,
      ),
      easyTierPublicServerUrlController: data.dec(
        _f$easyTierPublicServerUrlController,
      ),
      onChangeEasyTierEnabled: data.dec(_f$onChangeEasyTierEnabled),
      onChangeEasyTierNetworkName: data.dec(_f$onChangeEasyTierNetworkName),
      onChangeEasyTierNetworkSecret: data.dec(_f$onChangeEasyTierNetworkSecret),
      onChangeEasyTierPublicServerUrl: data.dec(
        _f$onChangeEasyTierPublicServerUrl,
      ),
    );
  }
...
abstract class SettingsTabVmCopyWith<$R, $In extends SettingsTabVm, $Out>
  ...
  $R call({
    ...
    TextEditingController? easyTierNetworkNameController,
    TextEditingController? easyTierNetworkSecretController,
    TextEditingController? easyTierPublicServerUrlController,
    void Function(bool)? onChangeEasyTierEnabled,
    void Function(String)? onChangeEasyTierNetworkName,
    void Function(String)? onChangeEasyTierNetworkSecret,
    void Function(String)? onChangeEasyTierPublicServerUrl,
  });
...
class _SettingsTabVmCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (easyTierNetworkNameController != null)
        #easyTierNetworkNameController: easyTierNetworkNameController,
      if (easyTierNetworkSecretController != null)
        #easyTierNetworkSecretController: easyTierNetworkSecretController,
      if (easyTierPublicServerUrlController != null)
        #easyTierPublicServerUrlController: easyTierPublicServerUrlController,
      if (onChangeEasyTierEnabled != null)
        #onChangeEasyTierEnabled: onChangeEasyTierEnabled,
      if (onChangeEasyTierNetworkName != null)
        #onChangeEasyTierNetworkName: onChangeEasyTierNetworkName,
      if (onChangeEasyTierNetworkSecret != null)
        #onChangeEasyTierNetworkSecret: onChangeEasyTierNetworkSecret,
      if (onChangeEasyTierPublicServerUrl != null)
        #onChangeEasyTierPublicServerUrl: onChangeEasyTierPublicServerUrl,
    }),
  );
  @override
  SettingsTabVm $make(CopyWithData data) => SettingsTabVm(
    ...
    easyTierNetworkNameController: data.get(
      #easyTierNetworkNameController,
      or: $value.easyTierNetworkNameController,
    ),
    easyTierNetworkSecretController: data.get(
      #easyTierNetworkSecretController,
      or: $value.easyTierNetworkSecretController,
    ),
    easyTierPublicServerUrlController: data.get(
      #easyTierPublicServerUrlController,
      or: $value.easyTierPublicServerUrlController,
    ),
    onChangeEasyTierEnabled: data.get(
      #onChangeEasyTierEnabled,
      or: $value.onChangeEasyTierEnabled,
    ),
    onChangeEasyTierNetworkName: data.get(
      #onChangeEasyTierNetworkName,
      or: $value.onChangeEasyTierNetworkName,
    ),
    onChangeEasyTierNetworkSecret: data.get(
      #onChangeEasyTierNetworkSecret,
      or: $value.onChangeEasyTierNetworkSecret,
    ),
    onChangeEasyTierPublicServerUrl: data.get(
      #onChangeEasyTierPublicServerUrl,
      or: $value.onChangeEasyTierPublicServerUrl,
    ),
  );
