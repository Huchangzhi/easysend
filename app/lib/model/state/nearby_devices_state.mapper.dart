...
class NearbyDevicesStateMapper extends ClassMapperBase<NearbyDevicesState> {
  ...
  static Map<String, Device> _$easyTierDevices(NearbyDevicesState v) =>
      v.easyTierDevices;
  static const Field<NearbyDevicesState, Map<String, Device>>
  _f$easyTierDevices = Field(
    'easyTierDevices',
    _$easyTierDevices,
    opt: true,
    def: const {},
  ...
  final MappableFields<NearbyDevicesState> fields = const {
    ...
    #easyTierDevices: _f$easyTierDevices,
  ...
  static NearbyDevicesState _instantiate(DecodingData data) {
    return NearbyDevicesState(
      ...
      easyTierDevices: data.dec(_f$easyTierDevices),
    );
  }
...
>
  ...
  $R call({
    ...
    Map<String, Device>? easyTierDevices,
  });
...
class _NearbyDevicesStateCopyWithImpl<$R, $Out>
  ...
  @override
  MapCopyWith<$R, String, Device, DeviceCopyWith<$R, Device, Device>>
  get easyTierDevices => MapCopyWith(
    $value.easyTierDevices,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(easyTierDevices: v),
  );
  @override
  $R call({
    bool? runningFavoriteScan,
    ...
    FieldCopyWithData({
      ...
      if (easyTierDevices != null) #easyTierDevices: easyTierDevices,
    }),
  );
  @override
  NearbyDevicesState $make(CopyWithData data) => NearbyDevicesState(
    ...
    easyTierDevices: data.get(#easyTierDevices, or: $value.easyTierDevices),
  );
