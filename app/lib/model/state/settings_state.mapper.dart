...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static bool _$enableEasyTier(SettingsState v) => v.enableEasyTier;
  static const Field<SettingsState, bool> _f$enableEasyTier = Field(
    'enableEasyTier',
    _$enableEasyTier,
    opt: true,
    def: false,
  );
  static String _$easyTierNetworkName(SettingsState v) => v.easyTierNetworkName;
  static const Field<SettingsState, String> _f$easyTierNetworkName = Field(
    'easyTierNetworkName',
    _$easyTierNetworkName,
    opt: true,
    def: '',
  );
  static String _$easyTierNetworkSecret(SettingsState v) =>
      v.easyTierNetworkSecret;
  static const Field<SettingsState, String> _f$easyTierNetworkSecret = Field(
    'easyTierNetworkSecret',
    _$easyTierNetworkSecret,
    opt: true,
    def: '',
  );
  static String _$easyTierPublicServerUrl(SettingsState v) =>
      v.easyTierPublicServerUrl;
  static const Field<SettingsState, String> _f$easyTierPublicServerUrl = Field(
    'easyTierPublicServerUrl',
    _$easyTierPublicServerUrl,
    opt: true,
    def: 'tcp://public.easytier.cn:11010',
  );
  ...
  final MappableFields<SettingsState> fields = const {
    ...
    #enableEasyTier: _f$enableEasyTier,
    #easyTierNetworkName: _f$easyTierNetworkName,
    #easyTierNetworkSecret: _f$easyTierNetworkSecret,
    #easyTierPublicServerUrl: _f$easyTierPublicServerUrl,
  };
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
      ...
      enableEasyTier: data.dec(_f$enableEasyTier),
      easyTierNetworkName: data.dec(_f$easyTierNetworkName),
      easyTierNetworkSecret: data.dec(_f$easyTierNetworkSecret),
      easyTierPublicServerUrl: data.dec(_f$easyTierPublicServerUrl),
    );
  }
...
abstract class SettingsStateCopyWith<$R, $In extends SettingsState, $Out>
  ...
  $R call({
    ...
    String? easyTierNetworkSecret,
    String? easyTierPublicServerUrl,
  });
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (enableEasyTier != null) #enableEasyTier: enableEasyTier,
      if (easyTierNetworkName != null)
        #easyTierNetworkName: easyTierNetworkName,
      if (easyTierNetworkSecret != null)
        #easyTierNetworkSecret: easyTierNetworkSecret,
      if (easyTierPublicServerUrl != null)
        #easyTierPublicServerUrl: easyTierPublicServerUrl,
    }),
  );
  @override
  SettingsState $make(CopyWithData data) => SettingsState(
    ...
    enableEasyTier: data.get(#enableEasyTier, or: $value.enableEasyTier),
    easyTierNetworkName: data.get(
      #easyTierNetworkName,
      or: $value.easyTierNetworkName,
    ),
    easyTierNetworkSecret: data.get(
      #easyTierNetworkSecret,
      or: $value.easyTierNetworkSecret,
    ),
    easyTierPublicServerUrl: data.get(
      #easyTierPublicServerUrl,
      or: $value.easyTierPublicServerUrl,
    ),
  );
